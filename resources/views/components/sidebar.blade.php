...
<div class="mb-4">
    <small class="mb-2 text-secondary d-block">Band</small>
...
<div class="mb-4">
    <small class="mb-2 text-secondary d-block">Album</small>
    <div class="list-group">
...
<div class="mb-4">
    <small class="mb-2 text-secondary d-block">Genre</small>
    <div class="list-group">
...
<div class="mb-4">
    <small class="mb-2 text-secondary d-block">Lyrics</small>
    <div class="list-group">
